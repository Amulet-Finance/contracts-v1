...
impl Flavour {
    ...
    fn mint_msg(&self, sender: &str, recipient: &str, denom: Denom, amount: u128) -> Binary {
        match self {
    ...
    fn burn_msg(&self, sender: &str, denom: Denom, amount: u128) -> Binary {
        match self {
...
impl<'a, Msg> CwTokenFactory<Msg> for TokenFactory<'a> {
