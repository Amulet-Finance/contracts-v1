...
const hermesRelayer: CosmoparkRelayer = {
    ...
    config: {
        "chains.0.max_gas": 1000000,
        "chains.0.default_gas": 500000,
        "chains.0.gas_multiplier": 1.3,
        "chains.0.trusting_period": "7days",
        "chains.1.max_gas": 1000000,
        "chains.1.gas_multiplier": 1.3,
        "chains.1.default_gas": 500000,
        "chains.1.gas_price": {
